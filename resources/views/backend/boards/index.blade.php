                    ...
                    @foreach($boards as $board)
                        ...
                        <tr>
                            ...
                            <td class="cta-group-item">
                                ...
                                <a href="{{ route('edit-board', $board->id) }}" class="btn btn-outline-primary btn-sm" id="btn-edit-group"
                                ...
                                <a href="{{ route('edit-infocards', $board->id) }}" class="btn btn-outline-primary btn-sm" id="btn-edit-group"
