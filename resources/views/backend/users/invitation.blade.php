        ...
        <div class="row justify-content-center align-items-stretch align-content-stretch">
            ...
            <div class="col-md-5 bg-dark left-col d-flex flex-wrap justify-content-center align-content-center align-items-center">
                ...
                <div class="animation-overlay">
                    <div class="xmark xmark-1">
                        <div class="h-line"></div>
                        <div class="v-line"></div>
                    </div>
                    <div class="xmark xmark-2">
                        <div class="h-line"></div>
                        <div class="v-line"></div>
                    </div>
                    <div class="xmark xmark-3">
                        <div class="h-line"></div>
                        <div class="v-line"></div>
                    </div>
                    <div class="xmark xmark-4">
                        <div class="h-line"></div>
                        <div class="v-line"></div>
                    </div>
                ...
                <div class="register-form">
                    <form method="POST" action="{{ route('register', app()->getLocale()) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" readonly type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email }}" required autocomplete="email" placeholder="ex: email@domain.com">
