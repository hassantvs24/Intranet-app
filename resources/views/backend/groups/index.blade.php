                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="cta-group-item">
                            <a href="{{ route('view-group',$group->id) }}" class="btn btn-outline-primary btn-sm" id="btn-view-group">
                            ...
                            <a href="{{ route('edit-group',$group->id) }}" class="btn btn-outline-primary btn-sm" id="btn-edit-group">
