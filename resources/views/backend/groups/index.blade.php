...
<div class="container-fluid p-4">
    ...
    <div class="row mb-4 align-items-center align-content-center">
        ...
        <div class="col text-right">
            <a href="{{ route('create-group', app()->getLocale()) }}" class="btn btn-primary btn-md">{{ __('Create New') }}</a>
        </div>
    </div>
            ...
            <table class="table table--all-groups shadow-sm rounded border-0 overflow-hidden">
                ...
                @if(count($groups) > 0)
                    ...
                    <tr>
                        ...
                        <td><a href="#" class="add_board" data-id="{{$group->id}}" data-toggle="modal" data-target="#add_board_option">{{__('Add Board')}}</a></td>
                        <td class="cta-group-item">
                            <a href="{{ route('user-invite',[ app()->getLocale(), $group->id ]) }}" class="btn btn-outline-primary btn-sm" id="btn-view-group">
                            ...
                            <a href="{{ route('edit-group', [ app()->getLocale(), $group->id ] ) }}" class="btn btn-outline-primary btn-sm" id="btn-edit-group">
                            ...
                            <a href="{{route('delete-group',[ app()->getLocale(), $group->id ])}}" class="btn btn-outline-primary btn-sm" id="btn-delete-group">
                    ...
                    <tr>
                        <td>
                            {{ __('No records found.') }}
                            <a href="{{ route('create-group', app()->getLocale()) }}">{{ __('Create new.') }}</a>
                        </td>
                    </tr>
                    @endif
                </tbody>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">{{__('Add Board')}}</h5>
