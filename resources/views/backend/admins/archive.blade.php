...
@section('admin-content')
    <div class="container-fluid p-4">
        ...
        <div class="row  mb-4 align-items-center align-content-center">
            <div class="col">
            <form action="{{ route('search-admin-archive', [ app()->getLocale() ] ) }}" method="get">
                    <div class="form-row">
                        <div class="col col-md-5">
                            <div class="input-group">
                                ...
                                <input type="search" class="form-control border-left-0" id="inputGroupFile01" aria-describedby="search-icon" name="search" value="@if( !empty( $_GET['search'] ) ) {{ $_GET['search'] }} @endif ">
                            </div>
                        </div>
                    </div>
                </form>
