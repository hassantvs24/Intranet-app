    ...
    <div class="group-create-wrap">
        <div class="container-fluid p-4">
            ...
            <div class="row mb-4">
                <div class="col-md-10">
                    <div class="card">
                        <form id="form_cr" action="{{route('groups.invite-exist.save', app()->getLocale())}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <h5 class="card-header mb-3">{{__('Invite exist users')}}</h5>
                            <div class="card-body">
